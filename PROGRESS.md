...
### 2. [ ] 傳入 is_last_tile 旗標，實作河底撈魚（+1）與海底撈月（+1）
...
### 6. [ ] main() 實作天聽（+8）與地聽（+4）旗標並傳入 score_hand()
...
### 7. [ ] README.md 將已實作規則從「尚未實作」列表中移除
